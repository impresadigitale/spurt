...
INSERT INTO `attribute_group` VALUES (2,'SCHEDA TECNICA',1,'2021-05-12 16:11:36','2021-05-12 19:30:33',NULL,NULL),(3,'INFORMAZIONI AGGIUNTIVE',2,'2021-05-12 18:11:38','2021-05-12 19:04:27',NULL,NULL),(4,'ACCESSORI',3,'2021-05-29 14:38:40','2021-05-29 14:38:40',NULL,NULL);
...
INSERT INTO `category` VALUES (160,'SERVIZI & ACCESSORI',NULL,NULL,0,1,'','','','1',NULL,NULL,'2021-05-13 18:13:50','2021-05-13 18:14:02','servizi--accessori'),(161,'KM 0',NULL,NULL,0,2,'','','','1',NULL,NULL,'2021-05-13 18:14:13',NULL,'km-0'),(162,'AFFARI DEL MESE',NULL,NULL,0,3,'','','','1',NULL,NULL,'2021-05-13 18:14:44',NULL,'affari-del-mese');
...
INSERT INTO `customer_group` VALUES (1,'default','default',1,NULL,NULL,'2020-02-24 09:09:22','2020-04-18 07:23:31','#0000ff');
...
INSERT INTO `language` VALUES (57,'English','eng','Img_1557133081101.png','language/',NULL,1,1,'2019-05-06 03:58:01','2020-02-03 11:44:52',NULL,NULL),(59,'French','fr','Img_1557569207176.png','language/',NULL,1,1,'2019-05-11 05:06:47',NULL,NULL,NULL),(60,'Italiano','it',NULL,NULL,NULL,1,1,'2021-05-29 16:39:11','2021-05-29 16:39:22',NULL,NULL);
...
INSERT INTO `login_log` VALUES (1,1,'demo@gmail.com','demo','::1','2020-07-15 13:42:20',NULL,NULL,NULL),(2,1,'demo@gmail.com','demo','::1','2020-07-15 14:27:18',NULL,NULL,NULL),(3,1,'demo@gmail.com','demo','::1','2020-12-03 20:33:14',NULL,NULL,NULL);
...
INSERT INTO `page` VALUES (1,'Location',NULL,'<p>dsad</p>\n',1,NULL,'location','location','location',NULL,1,NULL,NULL,'2021-05-28 16:04:55','2021-05-31 21:03:15','location-1');
...
INSERT INTO `page_group` VALUES (1,'Location',1,'2021-05-28 16:04:40','2021-05-28 16:04:40',NULL,NULL);
...
INSERT INTO `tax` VALUES (3,'IVA',22,1,NULL,'2021-05-29 16:39:39',NULL,NULL);
...
INSERT INTO `user_group` VALUES (1,'Admin','optional',1,'2019-01-21 10:38:14','2019-05-14 01:24:32',NULL,NULL,NULL);
...
--
-- Table structure for table `zz_anafin`
--

DROP TABLE IF EXISTS `zz_anafin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `zz_anafin` (
  `FICODICE` varchar(20) NOT NULL COMMENT 'Codice',
  `FIDESCRI` varchar(50) NOT NULL COMMENT 'Descrizione',
  PRIMARY KEY (`FICODICE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `zz_anafin`
--

LOCK TABLES `zz_anafin` WRITE;
/*!40000 ALTER TABLE `zz_anafin` DISABLE KEYS */;
/*!40000 ALTER TABLE `zz_anafin` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-06-01  9:02:23

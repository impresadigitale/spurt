...
export class CurrencyEffect {
  ...
  // currency list
  @Effect()
  docurrencyList$: Observable<Action> = this.action$.pipe(
  ...
  // currency list count
  @Effect()
  docurrencyListCount$: Observable<Action> = this.action$.pipe(
  ...
  // new  currency add
  @Effect()
  docurrencyNew$: Observable<Action> = this.action$.pipe(
  ...
  // update currency
  @Effect()
  docurrencyUpdate$: Observable<Action> = this.action$.pipe(

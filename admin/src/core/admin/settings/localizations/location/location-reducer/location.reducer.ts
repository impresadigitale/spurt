...
export const newLocation = (state: LocationState) => state.newLocation;
export const updateLocation = (state: LocationState) => state.updateLocation;
export const locationDelete = (state: LocationState) => state.locationDelete;
export const locationList = (state: LocationState) => state.locationList;
export const locationPagination = (state: LocationState) => state.locationPagination;

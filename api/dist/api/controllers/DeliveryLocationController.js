...
let DeliveryLocationController = class DeliveryLocationController {
    ...
    /**
     * @api {post} /api/admin-delivery-location/add-delivery-location Add Delivery Location API
     * @apiGroup Admin Delivery Location
     ...
     *      "status": "1"
     * }
     * @apiSampleRequest /api/admin-delivery-location/add-delivery-location
     * @apiErrorExample {json} Admin Delivery Location error
    ...
    /**
     * @api {delete} /api/admin-delivery-location/delete-delivery-location/:deliveryLocationId Delete Delivery Location API
     * @apiGroup Admin Delivery Location
     * @apiHeader {String} Authorization
     * @apiParamExample {json} Input
     * {
     ...
     *      "status": "1"
     * }
     * @apiSampleRequest /api/admin-delivery-location/delete-delivery-location/:deliveryLocationId
    ...
    /**
     * @api {put} /api/admin-delivery-location/update-delivery-location/:deliveryLocationId Update Delivery Location API
     * @apiGroup Admin Delivery Location
     * @apiHeader {String} Authorization
     ...
     *      "data" : "{}"
     * }
     * @apiSampleRequest /api/admin-delivery-location/update-delivery-location/:deliveryLocationId
     * @apiErrorExample {json} Update Delivery Location API error
     * HTTP/1.1 500 Internal Server Error
     */
    updateDeliveryLocation(updateParam, deliveryLocationId, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const deliveryLocation = yield this.deliveryLocationService.findOne({
                where: {
                    deliveryLocationId,
    ...
    /**
     * @api {get} /api/admin-delivery-location/delivery-location-list Delivery Location List API
     * @apiGroup Admin Delivery Location
     * @apiHeader {String} Authorization
     ...
     *      "data" : "{ }"
     * }
     * @apiSampleRequest /api/admin-delivery-location/delivery-location-list
    ...
    /**
     * @api {post} /api/admin-delivery-location/import-delivery-location Import Delivery Location
     * @apiGroup Admin Delivery Location
     * @apiHeader {String} Authorization
     ...
     *      "data": {},
     * }
     * @apiSampleRequest /api/admin-delivery-location/import-delivery-location
    ...
    importDeliveryLocation(file, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const data of subjectData) {
                ...
                newDeliveryLocation.vendorId = 0;
                newDeliveryLocation.zipCode = data.zipCode;
                ...
                if (data.locationName) {
                    const deliveryLocations = data.locationName;
                    const locations = deliveryLocations.split(',');
                    for (const location of locations) {
                        const deliveryLocationToLocation = new DeliveryLocationToLocation_1.DeliveryLocationToLocation();
    ...
    /**
     * @api {get} /api/admin-delivery-location/download-delivery-location Download Delivery Location
     * @apiGroup Admin Delivery Location
     * @apiSuccessExample {json} Success
     * HTTP/1.1 200 OK
     * {
     ...
     *      "status": "1",
     * }
     * @apiSampleRequest /api/admin-delivery-location/download-delivery-location
...
tslib_1.__decorate([
    ...
    tslib_1.__param(1, routing_controllers_1.Param('deliveryLocationId')), tslib_1.__param(2, routing_controllers_1.Res()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [CreateDeliveryLocationRequest_1.CreateDeliveryLocationRequest, Number, Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
DeliveryLocationController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/admin-delivery-location'),

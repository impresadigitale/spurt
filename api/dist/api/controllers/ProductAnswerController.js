...
let ProductAnswerController = class ProductAnswerController {
    constructor(productQuestionService, productAnswerService, customerService, userService) {
...
tslib_1.__decorate([
    routing_controllers_1.Put('/update-answer/:answerId'),
    routing_controllers_1.Authorized(),
    tslib_1.__param(0, routing_controllers_1.Param('answerId')), tslib_1.__param(1, routing_controllers_1.BodyParam('answer')), tslib_1.__param(2, routing_controllers_1.Res()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ProductAnswerController.prototype, "updateAnswer", null);
tslib_1.__decorate([
    routing_controllers_1.Put('/update-answer-status/:answerId'),
    routing_controllers_1.Authorized(),
    tslib_1.__param(0, routing_controllers_1.Param('answerId')), tslib_1.__param(1, routing_controllers_1.BodyParam('status')), tslib_1.__param(2, routing_controllers_1.Res()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ProductAnswerController.prototype, "updateAnswerStatus", null);
tslib_1.__decorate([
    routing_controllers_1.Delete('/delete-answer/:answerId'),
    routing_controllers_1.Authorized(),
    tslib_1.__param(0, routing_controllers_1.Param('answerId')), tslib_1.__param(1, routing_controllers_1.Res()), tslib_1.__param(2, routing_controllers_1.Req()),
    tslib_1.__metadata("design:type", Function),
...
tslib_1.__decorate([
    routing_controllers_1.Put('/make-default-answer/:answerId'),
    routing_controllers_1.Authorized(),
    tslib_1.__param(0, routing_controllers_1.Param('answerId')), tslib_1.__param(1, routing_controllers_1.Res()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ProductAnswerController.prototype, "updateDefaultAnswer", null);
ProductAnswerController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/admin-product-answer'),

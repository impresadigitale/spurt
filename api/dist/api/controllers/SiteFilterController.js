...
const SiteFilterService_1 = require("../services/SiteFilterService");
...
tslib_1.__decorate([
    routing_controllers_1.Post('/create-site-filter'),
...
tslib_1.__decorate([
    routing_controllers_1.Put('/update-site-filter/:id'),
    routing_controllers_1.Authorized(),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/site-filter-list'),
    routing_controllers_1.Authorized(),
...
tslib_1.__decorate([
    routing_controllers_1.Delete('/delete-site-filter/:id'),
    routing_controllers_1.Authorized(),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/filter-detail/:id'),
    routing_controllers_1.Authorized(),
...
SiteFilterController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/site-filter'),

...
let CustomerController = class CustomerController {
    constructor(customerWishlistService, taxService, skuService, productVarientOptionService, productImageService, productService, productDiscountService, productSpecialService) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const promises = wishlistData.map((results) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (productData.isSimplified === 1) {
                    skuValue = yield this.skuService.findOne({ id: productData.skuId });
                    if (skuValue) {
                    ...
                    skuValue = yield this.productVarientOptionService.findOne({ productId: productData.productId, isActive: 1 });
                    if (skuValue) {
                        ...
                        const sku = yield this.skuService.findOne({ id: productData.skuId });
                        if (sku) {
...
CustomerController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [CustomerWishlistService_1.CustomerWishlistService, TaxService_1.TaxService, SkuService_1.SkuService, ProductVarientOptionService_1.ProductVarientOptionService,

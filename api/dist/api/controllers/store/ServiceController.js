    ...
    SendEnquiry(enquiryParam, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (enquirySave) {
                ...
                mail_services_1.MAILService.customerLoginMail(logo, message, enquiryParam.email, emailContent.subject, redirectUrl);
                const successResponse = {
                    status: 1,
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, routing_controllers_1.QueryParam('limit')), tslib_1.__param(1, routing_controllers_1.QueryParam('offset')), tslib_1.__param(2, routing_controllers_1.QueryParam('keyword')), tslib_1.__param(3, routing_controllers_1.QueryParam('categoryId')), tslib_1.__param(4, routing_controllers_1.QueryParam('count')), tslib_1.__param(5, routing_controllers_1.Res()),
...
tslib_1.__decorate([
    routing_controllers_1.Post('/store-enquiry'),
...
StoreServiceController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/store-service'),

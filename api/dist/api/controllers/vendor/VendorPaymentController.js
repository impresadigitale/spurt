...
let VendorPaymentController = class VendorPaymentController {
     ...
     * HTTP/1.1 500 Internal Server Error
     */
    exportBulkOrderPaymentList(response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const excel = require('exceljs');
            const workbook = new excel.Workbook();
...
tslib_1.__decorate([
    routing_controllers_1.Get('/payment-detail'),
    routing_controllers_1.Authorized(),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/payment-dashboard-count'),
    routing_controllers_1.Authorized(),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/vendor-order-payment-export'),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/export-bulk-order-payment-list'),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/payment-archive-list'),
    routing_controllers_1.Authorized(),
    tslib_1.__param(0, routing_controllers_1.QueryParam('limit')), tslib_1.__param(1, routing_controllers_1.QueryParam('offset')), tslib_1.__param(2, routing_controllers_1.QueryParam('customerName')),
    tslib_1.__param(3, routing_controllers_1.QueryParam('startDate')), tslib_1.__param(4, routing_controllers_1.QueryParam('endDate')), tslib_1.__param(5, routing_controllers_1.QueryParam('count')), tslib_1.__param(6, routing_controllers_1.Res()),
    tslib_1.__metadata("design:type", Function),
...
VendorPaymentController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/admin-vendor-payment'),

...
tslib_1.__decorate([
    routing_controllers_1.Get('/vendor-coupon-list'),
    routing_controllers_1.Authorized('vendor'),
...
tslib_1.__decorate([
    routing_controllers_1.Get('/vendor-coupon-detail'),
    routing_controllers_1.Authorized('vendor'),
...
tslib_1.__decorate([
    routing_controllers_1.Put('/update-vendor-coupon/:vendorCouponId'),
    routing_controllers_1.Authorized('vendor'),
...
tslib_1.__decorate([
    routing_controllers_1.Delete('/delete-vendor-coupon/:vendorCouponId'),
    routing_controllers_1.Authorized('vendor'),
    tslib_1.__param(0, routing_controllers_1.Param('vendorCouponId')), tslib_1.__param(1, routing_controllers_1.Req()), tslib_1.__param(2, routing_controllers_1.Res()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], CouponController.prototype, "deleteVendorCoupon", null);
CouponController = tslib_1.__decorate([
    routing_controllers_1.JsonController('/vendor-coupon'),

...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'reason_id' }),
    tslib_1.__metadata("design:type", Number)
], AnswerReportAbuse.prototype, "reasonId", void 0);
tslib_1.__decorate([
    typeorm_1.Column({ name: 'remark' }),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => ProductQuestion_1.ProductQuestion, productQuestion => productQuestion.answerReportAbuse),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => ProductAnswer_1.ProductAnswer, productAnswer => productAnswer.answerReportAbuse),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Customer_1.Customer, customer => customer.answerReportAbuse),
...
AnswerReportAbuse = tslib_1.__decorate([
    typeorm_1.Entity('answer_report_abuse')
], AnswerReportAbuse);

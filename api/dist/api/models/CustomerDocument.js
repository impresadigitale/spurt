...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'customer_document_id' }),
...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'document_status' }),
    tslib_1.__metadata("design:type", Number)
], CustomerDocument.prototype, "documentStatus", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Customer_1.Customer, customer => customer.customerDocument),
...
CustomerDocument = tslib_1.__decorate([
    typeorm_1.Entity('customer_document')
], CustomerDocument);

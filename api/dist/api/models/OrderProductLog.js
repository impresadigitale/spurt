...
tslib_1.__decorate([
    ...
    index_1.PrimaryGeneratedColumn({ name: 'order_product_log_id' }),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderProduct_1.OrderProduct, orderProduct => orderProduct.orderProductLog),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => ProductModel_1.Product, product => product.orderProductLog),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Order_1.Order, order => order.orderProductLog),
    typeorm_1.JoinColumn({ name: 'order_id' }),
    tslib_1.__metadata("design:type", Order_1.Order)
], OrderProductLog.prototype, "order", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderStatus_1.OrderStatus, orderStatus => orderStatus.orderProductLog),
...
OrderProductLog = tslib_1.__decorate([
    typeorm_1.Entity('order_product_log')
], OrderProductLog);

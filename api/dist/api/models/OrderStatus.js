...
tslib_1.__decorate([
    typeorm_1.OneToMany(type => VendorOrders_1.VendorOrders, vendorOrder => vendorOrder.orderStatus),
    tslib_1.__metadata("design:type", Array)
], OrderStatus.prototype, "vendorOrders", void 0);
tslib_1.__decorate([
    typeorm_1.OneToMany(type => VendorOrderArchive_1.VendorOrderArchive, vendorOrderArchive => vendorOrderArchive.orderStatus),
    tslib_1.__metadata("design:type", Array)
], OrderStatus.prototype, "vendorOrderArchive", void 0);
tslib_1.__decorate([
    typeorm_1.OneToMany(type => VendorOrderArchiveLog_1.VendorOrderArchiveLog, vendorOrderArchiveLog => vendorOrderArchiveLog.orderStatus),
    tslib_1.__metadata("design:type", Array)
...
tslib_1.__decorate([
    typeorm_1.OneToMany(type => OrderProductLog_1.OrderProductLog, orderProductLog => orderProductLog.orderStatus),
    tslib_1.__metadata("design:type", Array)

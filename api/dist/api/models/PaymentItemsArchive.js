...
tslib_1.__decorate([
    ...
    index_1.PrimaryGeneratedColumn({ name: 'payment_item_archive_id' }),
...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'payment_archive_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderProduct_1.OrderProduct, orderProduct => orderProduct.paymentItemsArchive),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => PaymentArchive_1.PaymentArchive, paymentArchive => paymentArchive.paymentItemsArchive),
    typeorm_1.JoinColumn({ name: 'payment_archive_id' }),
...
PaymentItemsArchive = tslib_1.__decorate([
    typeorm_1.Entity('payment_items_archive')
], PaymentItemsArchive);

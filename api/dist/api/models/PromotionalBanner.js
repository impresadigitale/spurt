...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'banner_id' }),
    tslib_1.__metadata("design:type", Number)
], PromotionalBanner.prototype, "bannerId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'banner_title' }),
    tslib_1.__metadata("design:type", String)
], PromotionalBanner.prototype, "bannerTitle", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'banner_link_type' }),
    tslib_1.__metadata("design:type", Number)
], PromotionalBanner.prototype, "bannerLinkType", void 0);
tslib_1.__decorate([
    typeorm_1.Column({ name: 'banner_description' }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'expire_date' }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    typeorm_1.OneToMany(type => PromotionalBannerItem_1.PromotionalBannerItem, promotionalBannerItem => promotionalBannerItem.promotionalBanner),
...
PromotionalBanner = tslib_1.__decorate([
    typeorm_1.Entity('promotional_banner')
], PromotionalBanner);

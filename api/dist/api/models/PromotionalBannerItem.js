...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'banner_id' }),
    tslib_1.__metadata("design:type", Number)
], PromotionalBannerItem.prototype, "bannerId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'ref_id' }),
    tslib_1.__metadata("design:type", Number)
], PromotionalBannerItem.prototype, "refId", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => PromotionalBanner_1.PromotionalBanner, promotionalBanner => promotionalBanner.promotionalBannerItem),
...
PromotionalBannerItem = tslib_1.__decorate([
    typeorm_1.Entity('promotional_banner_item')

...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'service_category_path_id' }),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => ServiceCategory_1.ServiceCategory, serviceCategory => serviceCategory.category),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => ServiceCategory_1.ServiceCategory, serviceCategory => serviceCategory.path),
    typeorm_1.JoinColumn({ name: 'path_id' }),
    tslib_1.__metadata("design:type", ServiceCategory_1.ServiceCategory)
], ServiceCategoryPath.prototype, "path", void 0);
ServiceCategoryPath = tslib_1.__decorate([
    typeorm_1.Entity('service_category_path')
], ServiceCategoryPath);

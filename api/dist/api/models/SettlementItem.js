...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'settlement_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Settlement_1.Settlement, settlement => settlement.settlementItem),
    typeorm_1.JoinColumn({ name: 'settlement_id' }),
...
SettlementItem = tslib_1.__decorate([
    typeorm_1.Entity('settlement_item')
], SettlementItem);

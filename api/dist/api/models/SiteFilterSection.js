...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'site_filter_id' }),
    tslib_1.__metadata("design:type", Number)
], SiteFilterSection.prototype, "filterId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'section_id' }),
    tslib_1.__metadata("design:type", Number)
], SiteFilterSection.prototype, "sectionId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'section_name' }),
...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'section_slug' }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => SiteFilter_1.SiteFilter, filter => filter.filterSection),
    typeorm_1.JoinColumn({ name: 'site_filter_id' }),
    tslib_1.__metadata("design:type", SiteFilter_1.SiteFilter)
], SiteFilterSection.prototype, "filterDetail", void 0);
tslib_1.__decorate([
    typeorm_1.OneToMany(type => SiteFilterSectionItem_1.SiteFilterSectionItem, filterSectionItem => filterSectionItem.filterSectionDetail),
    tslib_1.__metadata("design:type", Array)
], SiteFilterSection.prototype, "filterSectionItem", void 0);
SiteFilterSection = tslib_1.__decorate([
    typeorm_1.Entity('site_filter_section')
], SiteFilterSection);

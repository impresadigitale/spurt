...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'site_filter_section_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'item_slug' }),
    tslib_1.__metadata("design:type", String)
], SiteFilterSectionItem.prototype, "itemSlug", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => SiteFilterSection_1.SiteFilterSection, filterSection => filterSection.filterSectionItem),
    typeorm_1.JoinColumn({ name: 'site_filter_section_id' }),
...
SiteFilterSectionItem = tslib_1.__decorate([
    typeorm_1.Entity('site_filter_section_item')

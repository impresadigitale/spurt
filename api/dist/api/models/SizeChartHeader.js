...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'size_chart_id' }),
    tslib_1.__metadata("design:type", Number)
], SizeChartHeader.prototype, "sizeChartId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'header_text_value' }),
    tslib_1.__metadata("design:type", String)
], SizeChartHeader.prototype, "headerTextValue", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => SizeChart_1.SizeChart, sizeChart => sizeChart.sizeChartHeader),
    typeorm_1.JoinColumn({ name: 'size_chart_id' }),
...
SizeChartHeader = tslib_1.__decorate([
    typeorm_1.Entity('size_chart_header')
], SizeChartHeader);

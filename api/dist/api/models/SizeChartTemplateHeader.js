...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'template_id' }),
    tslib_1.__metadata("design:type", Number)
], SizeChartTemplateHeader.prototype, "templateId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'header_id' }),
    tslib_1.__metadata("design:type", Number)
], SizeChartTemplateHeader.prototype, "headerId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'header_text' }),
    tslib_1.__metadata("design:type", String)
], SizeChartTemplateHeader.prototype, "headerText", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => HeaderTextModel_1.HeaderText, headerText => headerText.templateHeader),
    typeorm_1.JoinColumn({ name: 'header_id' }),
    tslib_1.__metadata("design:type", HeaderTextModel_1.HeaderText)
], SizeChartTemplateHeader.prototype, "header", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => SizeChartTemplate_1.SizeChartTemplate, sizeChartTemplate => sizeChartTemplate.templateHeader),
    typeorm_1.JoinColumn({ name: 'template_id' }),
...
SizeChartTemplateHeader = tslib_1.__decorate([
    typeorm_1.Entity('size_chart_template_header')

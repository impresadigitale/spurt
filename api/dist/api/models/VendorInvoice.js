...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'vendor_invoice_id' }),
...
tslib_1.__decorate([
    typeorm_1.OneToMany(type => VendorInvoiceItem_1.VendorInvoiceItem, vendorInvoiceItem => vendorInvoiceItem.vendorInvoice),
...
VendorInvoice = tslib_1.__decorate([
    typeorm_1.Entity('vendor_invoice')
], VendorInvoice);

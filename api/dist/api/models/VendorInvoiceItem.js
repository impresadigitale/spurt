...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'vendor_invoice_item_id' }),
    tslib_1.__metadata("design:type", Number)
], VendorInvoiceItem.prototype, "vendorInvoiceItemId", void 0);
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'vendor_invoice_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => VendorInvoice_1.VendorInvoice, vendorInvoice => vendorInvoice.vendorInvoiceItem),
    typeorm_1.JoinColumn({ name: 'vendor_invoice_id' }),
...
VendorInvoiceItem = tslib_1.__decorate([
    typeorm_1.Entity('vendor_invoice_item')
], VendorInvoiceItem);

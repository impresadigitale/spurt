...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'vendor_order_archive_log_id' }),
    tslib_1.__metadata("design:type", Number)
], VendorOrderArchiveLog.prototype, "vendorOrderArchiveLogId", void 0);
tslib_1.__decorate([
    typeorm_1.Column({ name: 'vendor_order_archive_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Vendor_1.Vendor, vendor => vendor.vendorOrderArchiveLog),
    typeorm_1.JoinColumn({ name: 'vendor_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrderArchiveLog.prototype, "vendor", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderProduct_1.OrderProduct, orderProduct => orderProduct.vendorOrderArchive),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderStatus_1.OrderStatus, orderStatus => orderStatus.vendorOrderArchiveLog),
    typeorm_1.JoinColumn({ name: 'sub_order_status_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrderArchiveLog.prototype, "orderStatus", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Order_1.Order, order => order.vendorOrderArchiveLog),
    typeorm_1.JoinColumn({ name: 'order_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrderArchiveLog.prototype, "order", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => VendorOrderArchive_1.VendorOrderArchive, vendorOrderArchive => vendorOrderArchive.vendorOrderArchiveLog),
    typeorm_1.JoinColumn({ name: 'vendor_order_archive_id' }),
    tslib_1.__metadata("design:type", Array)
...
VendorOrderArchiveLog = tslib_1.__decorate([
    typeorm_1.Entity('vendor_order_archive_log')

...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'vendor_order_log_id' }),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Vendor_1.Vendor, vendor => vendor.vendororderlog),
    typeorm_1.JoinColumn({ name: 'vendor_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrderLog.prototype, "vendor", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Order_1.Order, order => order.vendororderlog),
...
VendorOrderLog = tslib_1.__decorate([
    typeorm_1.Entity('vendor_orders_log')
], VendorOrderLog);

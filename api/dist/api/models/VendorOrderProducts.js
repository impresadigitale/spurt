...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'vendor_order_product_id' }),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => VendorOrders_1.VendorOrders, vendorOrders => vendorOrders.vendororderproducts),
    typeorm_1.JoinColumn({ name: 'vendor_order_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrderProducts.prototype, "vendororder", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderProduct_1.OrderProduct, orderProduct => orderProduct.vendororderproduct),
...
VendorOrderProducts = tslib_1.__decorate([
    typeorm_1.Entity('vendor_order_products')
], VendorOrderProducts);

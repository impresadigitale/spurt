...
tslib_1.__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ name: 'vendor_order_id' }),
    tslib_1.__metadata("design:type", Number)
], VendorOrders.prototype, "vendorOrderId", void 0);
tslib_1.__decorate([
    typeorm_1.Column({ name: 'sub_order_id' }),
...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'sub_order_status_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'make_settlement' }),
    tslib_1.__metadata("design:type", Number)
], VendorOrders.prototype, "makeSettlement", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Vendor_1.Vendor, vendor => vendor.vendororder),
    typeorm_1.JoinColumn({ name: 'vendor_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrders.prototype, "vendor", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderProduct_1.OrderProduct, orderProduct => orderProduct.vendorOrders),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => OrderStatus_1.OrderStatus, orderStatus => orderStatus.vendorOrders),
    typeorm_1.JoinColumn({ name: 'sub_order_status_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorOrders.prototype, "orderStatus", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Order_1.Order, order => order.vendorOrders),
...
tslib_1.__decorate([
    typeorm_1.OneToOne(type => OrderProduct_1.OrderProduct),
    typeorm_1.JoinColumn({ name: 'order_product_id' }),
    tslib_1.__metadata("design:type", OrderProduct_1.OrderProduct)
], VendorOrders.prototype, "orderProductDetail", void 0);
tslib_1.__decorate([
    typeorm_1.OneToMany(type => VendorOrderProducts_1.VendorOrderProducts, vendorOrderProducts => vendorOrderProducts.vendororder),
    tslib_1.__metadata("design:type", Array)
], VendorOrders.prototype, "vendororderproducts", void 0);
tslib_1.__decorate([
    typeorm_1.OneToMany(type => DeliveryAllocation_1.DeliveryAllocation, deliveryAllocation => deliveryAllocation.vendorOrders),
    tslib_1.__metadata("design:type", Array)
], VendorOrders.prototype, "deliveryAllocation", void 0);
tslib_1.__decorate([
    typeorm_1.OneToMany(type => VendorPayment_1.VendorPayment, vendorPayment => vendorPayment.vendorOrders),
    tslib_1.__metadata("design:type", Array)
...
VendorOrders = tslib_1.__decorate([
    typeorm_1.Entity('vendor_orders')
], VendorOrders);

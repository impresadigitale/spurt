...
tslib_1.__decorate([
    ...
    index_1.PrimaryGeneratedColumn({ name: 'vendor_payment_id' }),
...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'payment_item_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'commission_amount' }),
    tslib_1.__metadata("design:type", Number)
], VendorPayment.prototype, "commissionAmount", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => VendorOrders_1.VendorOrders, vendorOrders => vendorOrders.vendorPayment),
    typeorm_1.JoinColumn({ name: 'vendor_order_id' }),
    tslib_1.__metadata("design:type", Array)
], VendorPayment.prototype, "vendorOrders", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => PaymentItems_1.PaymentItems, paymentItems => paymentItems.vendorPayment),
    typeorm_1.JoinColumn({ name: 'payment_item_id' }),
    tslib_1.__metadata("design:type", PaymentItems_1.PaymentItems)
], VendorPayment.prototype, "paymentItems", void 0);
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Vendor_1.Vendor, vendor => vendor.vendorPayment),
...
VendorPayment = tslib_1.__decorate([
    typeorm_1.Entity('vendor_payment')
], VendorPayment);

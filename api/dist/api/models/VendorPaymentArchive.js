...
tslib_1.__decorate([
    typeorm_1.Column({ name: 'vendor_order_archive' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => PaymentItems_1.PaymentItems, paymentItems => paymentItems.vendorPaymentArchive),
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Vendor_1.Vendor, vendor => vendor.vendorPaymentArchive),
...
VendorPaymentArchive = tslib_1.__decorate([
    typeorm_1.Entity('vendor_payment_archive')

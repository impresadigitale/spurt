...
tslib_1.__decorate([
    class_validator_1.IsNotEmpty(),
    typeorm_1.Column({ name: 'widget_id' }),
    tslib_1.__metadata("design:type", Number)
...
tslib_1.__decorate([
    typeorm_1.ManyToOne(type => Widget_1.Widget, widget => widget.widgetItem),
    typeorm_1.JoinColumn({ name: 'widget_id' }),

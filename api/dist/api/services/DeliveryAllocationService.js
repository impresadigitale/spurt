...
exports.DeliveryAllocationService = void 0;
const tslib_1 = require("tslib");
const typedi_1 = require("typedi");
const typeorm_typedi_extensions_1 = require("typeorm-typedi-extensions");
const Logger_1 = require("../../decorators/Logger");
const DeliveryAllocation_1 = require("../models/DeliveryAllocation");
const DeliveryAllocationRepository_1 = require("../repositories/DeliveryAllocationRepository");
const typeorm_1 = require("typeorm");
let DeliveryAllocationService = class DeliveryAllocationService {
    constructor(deliveryAllocationRepository, log) {
    ...
    create(deliveryAllocation) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newDeliveryAllocation = yield this.deliveryAllocationRepository.save(deliveryAllocation);
            return newDeliveryAllocation;
        });
    }
    // update delivery allocation
    update(id, deliveryAllocation) {
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteDeliveryAllocation = yield this.deliveryAllocationRepository.delete(id);
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield typeorm_1.getConnection().getRepository(DeliveryAllocation_1.DeliveryAllocation).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
DeliveryAllocationService = tslib_1.__decorate([
    typedi_1.Service(),
    tslib_1.__param(0, typeorm_typedi_extensions_1.OrmRepository()),
    tslib_1.__param(1, Logger_1.Logger(__filename)),
    tslib_1.__metadata("design:paramtypes", [DeliveryAllocationRepository_1.DeliveryAllocationRepository, Object])
], DeliveryAllocationService);
exports.DeliveryAllocationService = DeliveryAllocationService;
//# sourceMappingURL=DeliveryAllocationService.js.map
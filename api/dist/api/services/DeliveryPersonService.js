...
const DeliveryPersonRepository_1 = require("../repositories/DeliveryPersonRepository");
const typeorm_1 = require("typeorm");
let DeliveryPersonService = class DeliveryPersonService {
    constructor(deliveryPersonRepository, log) {
    ...
    findOne(findCondition) {
        ...
        return this.deliveryPersonRepository.findOne(findCondition);
    }
    ...
    list(limit, offset, select = [], whereConditions = [], count) {
        ...
        if (count) {
            return this.deliveryPersonRepository.count(condition);
        }
        return this.deliveryPersonRepository.find(condition);
    }
    // create delivery person
    create(deliveryPerson) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newDeliveryPerson = yield this.deliveryPersonRepository.save(deliveryPerson);
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const deleteDeliveryPerson = yield this.deliveryPersonRepository.delete(id);
            return deleteDeliveryPerson;
        });
    }
    // custom Vendor product list
    queryList(limit, offset, vendorId, location) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.deliveryPersonRepository.deliveryPersonList(limit, offset, vendorId, location);
        });
    }
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield typeorm_1.getConnection().getRepository(DeliveryPerson_1.DeliveryPerson).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
DeliveryPersonService = tslib_1.__decorate([
    typedi_1.Service(),
    tslib_1.__param(0, typeorm_typedi_extensions_1.OrmRepository()),
    tslib_1.__param(1, Logger_1.Logger(__filename)),
    tslib_1.__metadata("design:paramtypes", [DeliveryPersonRepository_1.DeliveryPersonRepository, Object])
], DeliveryPersonService);
exports.DeliveryPersonService = DeliveryPersonService;
//# sourceMappingURL=DeliveryPersonService.js.map
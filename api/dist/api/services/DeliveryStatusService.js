...
let DeliveryStatusService = class DeliveryStatusService {
    ...
    findOne(findCondition) {
        return index_1.getConnection().getRepository(DeliveryStatus_1.DeliveryStatus).findOne(findCondition);
    }
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield index_1.getConnection().getRepository(DeliveryStatus_1.DeliveryStatus).createQueryBuilder();
            // Select
...
DeliveryStatusService = tslib_1.__decorate([
    typedi_1.Service(),
    tslib_1.__metadata("design:paramtypes", [])
], DeliveryStatusService);
exports.DeliveryStatusService = DeliveryStatusService;
//# sourceMappingURL=DeliveryStatusService.js.map
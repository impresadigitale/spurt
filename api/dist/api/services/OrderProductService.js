...
let OrderProductService = class OrderProductService {
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield typeorm_1.getConnection().getRepository(OrderProduct_1.OrderProduct).createQueryBuilder();
            // Select
    ...
    productVarientPaymentProcess(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.orderProductRepository.productVarientPaymentProcess(id);
        });
    }
};

...
let PaymentService = class PaymentService {
    ...
    create(product) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.paymentRepository.save(product);
            return newProduct;
        });
    }
    // find payment
    findAll(plugins) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.paymentRepository.find(plugins);
        });
    }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const newProduct = yield this.paymentRepository.delete(id);
            return newProduct;
        });
    }
    // find one plugin
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield index_1.getConnection().getRepository(Payment_1.Payment).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
PaymentService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [PaymentRepository_1.PaymentRepository])
], PaymentService);

...
exports.ServiceCategoryPathService = void 0;
const tslib_1 = require("tslib");
const typedi_1 = require("typedi");
const typeorm_typedi_extensions_1 = require("typeorm-typedi-extensions");
const ServiceCategoryPath_1 = require("../models/ServiceCategoryPath");
const ServiceCategoryPathRepository_1 = require("../repositories/ServiceCategoryPathRepository");
const index_1 = require("typeorm/index");
let ServiceCategoryPathService = class ServiceCategoryPathService {
    constructor(serviceCategoryPathRepository) {
        this.serviceCategoryPathRepository = serviceCategoryPathRepository;
    }
    ...
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.serviceCategoryPathRepository.delete(id);
            return;
        });
    }
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield index_1.getConnection().getRepository(ServiceCategoryPath_1.ServiceCategoryPath).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
ServiceCategoryPathService = tslib_1.__decorate([
    typedi_1.Service(),
    tslib_1.__param(0, typeorm_typedi_extensions_1.OrmRepository()),
    tslib_1.__metadata("design:paramtypes", [ServiceCategoryPathRepository_1.ServiceCategoryPathRepository])
], ServiceCategoryPathService);
exports.ServiceCategoryPathService = ServiceCategoryPathService;
//# sourceMappingURL=ServiceCategoryPathService.js.map
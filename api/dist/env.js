...
exports.env = {
    ...
    storeUrl: env_1.getOsEnv('STORE_URL'),
    cancelUrl: env_1.getOsEnv('CANCEL_URL'),
    baseUrl: env_1.getOsEnv('BASE_URL'),
    storeRedirectUrl: env_1.getOsEnv('STORE_REDIRECT_URL'),
    adminRedirectUrl: env_1.getOsEnv('ADMIN_REDIRECT_URL'),
    vendorRedirectUrl: env_1.getOsEnv('VENDOR_REDIRECT_URL'),
    imageUrl: env_1.getOsEnv('IMAGE_URL'),
};
exports.mail = {

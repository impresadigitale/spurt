...
import { PermissionModuleService } from '../services/PermissionModuleService';
import { PermissionModuleGroupService } from '../services/PermissionModuleGroupService';
...
export class PageController {
    ...
    @Post('/add-permission')
    @Authorized()
    public async addPermission(@BodyParam('refType') refType: number, @BodyParam('refId') refId: number, @BodyParam('permission') permission: string, @Res() response: any): Promise<any> {

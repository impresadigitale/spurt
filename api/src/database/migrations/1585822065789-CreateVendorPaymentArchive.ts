...
export class CreateVendorPaymentArchive1585822065789 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        const ifExsist = await queryRunner.hasTable('vendor_payment_archive');
        if (!ifExsist) {
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.dropTable('vendor_payment_archive', true);
    }

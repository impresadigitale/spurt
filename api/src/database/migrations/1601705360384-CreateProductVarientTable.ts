...
export class CreateProductVarientTable1601705360384 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const ifExsist = await queryRunner.hasTable('product_varient');
        if (!ifExsist) {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.dropTable('product_varient', true);
    }

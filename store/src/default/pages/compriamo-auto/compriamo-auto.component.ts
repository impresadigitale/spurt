...
@Component({
    selector: 'app-compriamo-auto',
    templateUrl: './compriamo-auto.component.html',
    styleUrls: ['./compriamo-auto.component.scss']
})
export class CompriamoAutoComponent implements OnInit {

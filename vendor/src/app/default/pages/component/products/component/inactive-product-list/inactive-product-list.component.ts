...
@Component({
  selector: 'app-inactive-product-list',
  templateUrl: './inactive-product-list.component.html',
  styleUrls: ['./inactive-product-list.component.scss'],
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class InActiveProductListComponent implements OnInit {
  ...
  public filterDataId = [];
  items = [{name: 'aaaaaa'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'},
  {name: 'bbbbbb'}, {name: 'bbbbbb'},
  {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}, {name: 'bbbbbb'}];
  public imageUrl = environment.imageUrl;
  public currencySymbol: any = JSON.parse(localStorage.getItem('vendor-settings'));

  constructor(public productSandbox: ProductSandbox, public router: Router, public toaster: ToastrService) {}

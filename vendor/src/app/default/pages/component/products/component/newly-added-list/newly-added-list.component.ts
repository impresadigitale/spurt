...
@Component({
  selector: 'app-newly-added-list',
  templateUrl: './newly-added-list.component.html',
  styleUrls: ['./newly-added-list.component.scss'],
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class NewlyAddedProductListComponent implements OnInit {
